...
if ($linhas != 1) {echo "Não foi possível editar/atualizar os dados no Banco de Dados. Tente novamente. Se o problema persistir, contacte o Administrador do Site.";}
